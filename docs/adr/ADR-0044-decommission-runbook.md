...
| | |
| --- | --- |
| Статус | accepted (**§2 и Фаза A2 амендированы [ADR-0048](./ADR-0048-external-send-contract-and-reply-restore.md)** — контракт ответа send + расщепление A2 на A2.1/A2.2) |
| Дата | 2026-07-10 |
